...
print(upbeat_table)
#Contingeny tables were generatd by ChatGPT basd on prompts I provided
...
hist(
  ...
  main = "Histogram for Intraverts",           # Title for the histogram
...
#Histograms were generatd by ChatGPT based on prompts I gave
...
axis(1, at = c(0, 1, 2))
#Histograms were generated by ChatGPT based on prompts I provided
# Calculate ranks for the dependent variable
...
#frequency tables were generated by chatgpt based on prompt I provided
################################################################################
...
#This plot was generated by ChatGPT based on the prompt I provided
...
#This code for was generated by ChatGPT based on prompt which I gave
